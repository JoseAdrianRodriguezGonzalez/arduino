...
void loop() {
  // put your main code here, to run repeatedly://Se incluyen las librerías del DHT
#include<DHT.h>
#include<DHT_U.h>
...
#define PULSADOR D5
String Internet = "INFINITUM0803_2.4";    //Nombre del internet INFINITUM1101 netsh wlan show profile
...
client.print("<div class='Juan'><h2>Temperatura= "+String(TEMPERATURA)+"c</h2><h2>Humedad="+String(HUMEDAD)+"%</h2><h2>Sensación termica="+String(hi)+"c</h2></div></div></body></html>");
//finaliza pagina
delay(10);
...
void fncontrolButton(){
  newButtonState=digitalRead(PULSADOR);
